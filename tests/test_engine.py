...
# =============================================================================
# HARDWARE FALLBACK STATE TESTS
# =============================================================================

class TestHardwareFallbackState:
    """Tests for hardware fallback state tracking."""
    ...
    def test_initial_fallback_state(self, engine):
        """Should start with fallback not active."""
        assert engine._hw_fallback_active is False
    
    def test_fallback_state_can_be_set(self, engine):
        """Should allow setting fallback state."""
        engine._hw_fallback_active = True
        assert engine._hw_fallback_active is True
