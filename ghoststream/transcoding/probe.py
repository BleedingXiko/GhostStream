"""
Media probing using ffprobe — Specter-native (gevent).

Uses subprocess.Popen (gevent monkey-patched) instead of asyncio.subprocess.
"""
...
class MediaProbe:
    ...
    def get_media_info(self, source: str, retry_count: int = 0) -> MediaInfo:
        ...
        try:
            ...
            try:
                stdout, stderr = gevent.with_timeout(
                    60.0,
                    process.communicate,
                )
                ...
                if retry_count < MAX_RETRIES:
                    ...
                    return self.get_media_info(source, retry_count + 1)
