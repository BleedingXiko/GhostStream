"""
Adaptive transcoding helpers for GhostStream.

The active Specter runtime currently uses the profiling and preset-selection
types from this module (`HardwareProfiler`, `SystemProfile`,
`AdaptiveQualitySelector`).

The lower monitoring/load-management block is retained for follow-up
evaluation, but it is not wired into the current Specter runtime graph and
should not be treated as active server behavior.
"""
...
from ....hardware import Capabilities, GPUInfo, HWAccelType
from ...domain.transcoding.constants import QUALITY_LADDER
from ...domain.transcoding.models import MediaInfo, QualityPreset
...
# =============================================================================
# DORMANT MONITORING / LOAD-MANAGEMENT SCAFFOLDING
# =============================================================================
#
# These types existed in the pre-rewrite adaptive module and may still be
# useful for a future Specter-native admission-control / quality-management
# service. They are intentionally kept isolated here for now, but they are not
# part of the active runtime assembly in `ghoststream.app.runtime`.
